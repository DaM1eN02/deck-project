...
var qrcode = function () {
  ...
  var qrcode = function (typeNumber, errorCorrectionLevel) {
    ...
    _this.createSvgTag = function (cellSize, margin, alt, title) {
      ...
      qrSvg += (title.text || alt.text)
        ? ' role="img" aria-labelledby="' +
          escapeXml([title.id, alt.id].join(" ").trim()) + '"'
        : "";
      qrSvg += ">";
      qrSvg += (title.text)
        ? '<title id="' + escapeXml(title.id) + '">' +
          escapeXml(title.text) + "</title>"
        : "";
      qrSvg += (alt.text)
        ? '<description id="' + escapeXml(alt.id) + '">' +
  ...
  var QRUtil = function () {
    ...
    var G15 = (1 << 10) | (1 << 8) | (1 << 5) | (1 << 4) | (1 << 2) | (1 << 1) |
      (1 << 0);
